export const validateFormUpdateClub = (data) => {
  ...
  if (!data.name.length) errors.name = "Debe ingresar el nombre del club";
    ...
    if (data.name.length > 25)
      errors.name = "Debe contener como máximo 25 caracteres";
  ...
  if (!data.adress || !data.adress.length)
    ...
    if (data.adress.length < 5)
      errors.adress = "Debe contener al menos 5 caracteres";
  ...
  if (!data.country.length) errors.country = "Debe ingresar el país del club";
    ...
    if (data.country.length < 3)
      errors.country = "Debe contener al menos 3 caracteres";
    if (data.country.length > 25)
      errors.country = "Debe contener como máximo 25 caracteres";
    if (!regExpLetter.test(data.country))
      errors.country = "Puede contener solo letras y espacios";
  }
  //STATUS
